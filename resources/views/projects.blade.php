...
<head>
    ...
    <title>Проекты | {{ config('app.name') }}</title>
    <!-- CSS -->
            ...
            <div class="t396">
                ...
                {"lid":1698922282908,"li_img":"{{ asset('storage/1/5.jpg')
                    ...
                    <div class="t396__elem tn-elem tn-elem__6617306041695797803907" data-elem-id="1695797803907"
                        ...
                        <h1 class="tn-atom" field="tn_text_1695797803907" style="line-height: 96px;">Все наши проекты
                        </h1>
                    </div>
                    <div class="t396__elem tn-elem tn-elem__6617306041695797803912" data-elem-id="1695797803912"
                        ...
                        <div class="tn-atom" field="tn_text_1695797803912" style="line-height: 29px;">Мы делаем сайты,
                            которые
                            помогают бизнесу расти. Вот наши проекты, которые мы сделали для
                            наших клиентов.</div>
                    </div>
                ...
                <div class="t396__artboard rendered" data-artboard-recid="671059438"
                    ...
                    <div class="t396__elem tn-elem tn-elem__6710594381700656842259" data-elem-id="1700656842259"
                        ...
                        style="top: 0px; left: 180.5px; width: 1160px; height: 70px;"> <a class="tn-atom"
                            href="http://vk.com/dekorartstroy">Смотрите наши проекты в ВК</a>
                    </div>
                </div>
            </div>
